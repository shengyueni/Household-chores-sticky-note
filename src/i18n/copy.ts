...
export const copy = {
  zh: {
    ...
    demoHomeButton: "进入唐宁的小家",
    createHomeButton: "创建家庭空间",
    savedHomeHint: "本地已经贴着一个家庭空间",
    continueHomePrefix: "继续进入",
    languageLabel: "中文",
    testMessage: "贴贴已准备好",
    nav: {
      today: "今日工作台",
    ...
    ui: {
      ...
      today: {
        ...
        noPending: "今天还没有待接便利贴。<br>点“加载演示数据”或去录入一张。",
      ...
      capture: {
        ...
        recognizedFileGeneric: "文件里识别到一条家庭事项，请确认标题、时间和接棒人。",
        recognizedFileClinic: "文件里识别到：{name}周三复诊，需空腹，带医保卡、病历和既往报告。",
        recognizedFileMeds: "文件里识别到药盒剩余不足，需要续购降压药。",
        voiceDefault: "{name}降压药快见底了，明早需要有人下单。",
        ownerLabel: "指派给",
  ...
  en: {
    appName: "Family Notes",
    appSubtitle: "Shared home tasks",
    appIntro: "Turn small household tasks into clear notes everyone can share.",
    demoHomeButton: "Enter Tang's House",
    createHomeButton: "Create Home",
    savedHomeHint: "A home space is already saved locally",
    continueHomePrefix: "Continue to",
    languageLabel: "EN",
    ...
    nav: {
      ...
      capture: "Add Note",
      wall: "Note Archive",
      protocol: "Family Handoff",
      balance: "Family Balance",
      familyInfo: "Family Settings"
    },
    pages: {
      today: { title: "Today", desc: "Small household notes, shared by everyone." },
      capture: { title: "Add a Note", desc: "Type a task, or use voice and files to start a draft." },
      wall: { title: "Note Archive", desc: "Track pending, claimed, and completed notes with context." },
      protocol: { title: "Family Handoff", desc: "Share handoffs in order, without blame or public shaming." },
      balance: { title: "Family Balance", desc: "See how observing, coordinating, doing, and backing up are distributed." },
      familyInfo: { title: "Family Settings", desc: "Edit the home name, slogan, and members used across every note." }
    },
    topbar: {
      ...
      allSleepProtected: "Everyone is protected for sleep, so this moved to the morning queue.",
      doNotDisturb: "Do not disturb these members at night",
      relayChoiceRequired: "Please choose someone who can take the handoff",
      current: "Current",
      notSelected: "Not selected",
      switchHome: "Switch Family",
      loadDemo: "Load Demo",
      broadcastOn: "Voice updates on",
      broadcastOff: "Voice updates off"
    },
    buttons: {
      claim: "I'll take it",
    ...
    ui: {
      ...
      modals: {
        ...
        protocol: {
          title: "Update handoff rules",
          desc: "Drag names to adjust the order. Members at the front will receive new notes first.",
          order: "Order {n}",
          drag: "Drag",
          save: "Save rules"
        },
        transfer: {
          ...
          desc: "The note will be handed off gently without ranking anyone.",
          send: "Send over"
        },
        switchFamily: {
          title: "Return to family entrance?",
        ...
        deleteMember: {
          ...
          defaultText: "Related notes will become unassigned.",
          removeText: "This member will be removed from the family list.",
          relatedText: "{count} related notes will become unassigned.",
          confirm: "Remove"
        },
        wish: {
          title: "Edit wish",
        ...
        proof: {
          ...
          desc: "After confirmation, this note will move to the archive and stay for 14 days."
        },
        avatar: {
          title: "Change avatar",
      ...
      today: {
        tipTitle: "Note Tip",
        sampleMeds: "Add a medicine note",
        defaultNext: "A small household task is waiting. The app will suggest the nearest helper first.",
        deviceName: "Seeed Screen - Living Room",
        sleepOn: "Sleep Guard on",
        deviceTitle: "Family note",
        deviceMeta: "Suggested helper pending - ETA today - context saved",
        ...
        noPending: "No pending notes today.<br>Load demo data or create one.",
        suggestPack: "Suggested: {name}",
        defaultTaskLine: "{care} says the medicine is running low. Suggested helper: {first} first, with {next} next.",
      ...
      capture: {
        title: "Add a Note",
        kicker: "Type a task, or use voice and files to start a draft.",
        voiceTitle: "Say it, and we draft it",
        voiceDesc: "Speech results appear in the draft so you can edit them",
        fileTitle: "Upload image / photo / document",
        fileDesc: "Recognition results appear below before you create a note",
        contentLabel: "Note content",
        defaultDraft: "There's a small household task someone can pick up tomorrow morning.",
        recognizedFileGeneric: "A household item was found in the file. Please confirm the title, time, and handoff person.",
        recognizedFileClinic: "The file mentions a clinic follow-up. Please confirm fasting, health card, medical records, and old reports.",
        recognizedFileMeds: "The file suggests the medicine box is running low and needs a refill.",
        voiceDefault: "Dad's blood pressure meds are almost out. Someone should order them tomorrow morning.",
        ownerLabel: "Assign to",
        emptyDraft: "Write something first, or use voice/file input.",
        listening: "Listening...",
        notHeard: "We did not catch that. Try voice again or type directly.",
        unsupported: "This browser does not support speech recognition. You can type below or try Chrome/Edge."
      },
      wall: {
        waitingTitle: "Waiting Notes",
        doneTitle: "Completed Notes",
        activeSummary: "{total} active - {pending} pending - {claimed} claimed",
        doneSummary: "{done} completed - kept for 14 days",
        emptyActive: "Your first note will appear here.<br>Use Add Note from the left.",
        emptyDone: "No completed notes yet.<br>Marked items will be collected here.",
        sampleMeds: "Medicine",
      ...
      protocol: {
        committeeTitle: "Family Handoff",
        subtitle: "Share handoffs in order, without blame or public shaming",
        updated: "Last updated: {time}",
        neverUpdated: "Not updated yet",
        routeTitle: "Current handoff order",
        statusTitle: "Handoff status",
        ...
        reviewSummary: "Today's summary: {done}/{total} notes were handled.",
        reviewSelfZero: "{name} handled 0 notes alone today. The night ones stayed outside the guardrail.",
        reviewSelfSome: "{name} handled {count} notes alone today. Next round, let someone else take one first.",
      ...
      familyInfo: {
        doorTitle: "Family Space",
        doorKicker: "Saved on this device, no account needed",
      ...
      demo: {
        ...
        done: "Demo complete: input, help request, Sleep Guard, clinic plan, and review all ran.",
        captions: ["Sleep Guard protects {name} first.", "Input creates a note.", "Help rules explain the recommendation.", "A note is handled and the balance changes.", "The clinic visit splits into 6 nodes.", "Review and monthly meeting close the loop."]
      }
    }
  }
} as const;
